...
const staff='11111111-1111-1111-1111-111111111111',manager='22222222-2222-2222-2222-222222222222',chief='33333333-3333-3333-3333-333333333333',other='44444444-4444-4444-4444-444444444444';
const prelude = `
...
try {
  ...
  await query(`insert into public.profiles values ('${staff}','staff',true,true),('${manager}','manager',true,true),('${chief}','chief',true,true),('${other}','staff',true,true)`);
