...
test('설명서는 직원 업무 동선과 권한 차이만 안내하고 민감한 원장 정보는 포함하지 않는다', () => {
  ...
  const text=guide[1];
  for(const phrase of ['홈에서 할 일 확인','근무표 확인','연차 신청','승인된 연차는 캘린더 안의 연차 보기에서 확인합니다.','공휴일 표시는 병원 휴무 의미가 아닐 수 있습니다','결재 문서','공지 확인','업무자료 보기','건의함','입사서류 제출','직원 서류함','체결된 근로계약서','권한 차이']){
