...
do $$ declare p oid:='public.review_manual_attendance(bigint,text)'::regprocedure; task7_current jsonb; begin
 ...
 if not exists(select 1 from employee_hub_private.push_subscriptions_semantic_fixture f where f.singleton and f.sha256='9e2745a2e1056172c67858e20ca9c61a0ee54e9877b980da2052f97565e6fb26' and f.canonical=task7_current->'canonical' and f.semantic_md5=md5((task7_current->'canonical')::text)) then raise exception 'Task 7 semantic fixture mismatch; preserve state and stop rollback'; end if;
 if not exists(select 1 from employee_hub_private.push_subscriptions_migration_marker m where m.fingerprint='task7-push-v4-portable' and m.manifest='push-v4-portable-20260921' and m.canonical=(task7_current->'canonical') and m.identity=(task7_current->'identity') and md5(m.canonical::text)='65dd743a0c94521c560bf8ae4dde4dc9' and md5((task7_current->'canonical')::text)='65dd743a0c94521c560bf8ae4dde4dc9') then raise exception 'Task 7 marker canonical or identity mismatch; preserve state and stop rollback'; end if;
