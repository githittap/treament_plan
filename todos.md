...
- ✅ **임은숙 계정 2개 정리(2026-09-12 완료)** — 원장 지시로 daum(les4128) **비활성**(approved=false·active=false, 하드삭제 아님·되돌리기 가능). 실사용 gmail(eunsooki4128)에 **실장(chief) 권한 이관**함. ⚠️원장 확인: 실장 승격을 원치 않으면 되돌림. (두 계정에 연차/기록이 나뉘어 있으면 추후 병합 필요할 수 있음.)
