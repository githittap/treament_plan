...
- 사용설명서 `Z:\11_codex\03_병원운영·전산\직원허브_수정지침_시안\직원허브_사용설명서.docx`의 제목 번호만 외과적으로 바로잡아 상담일지 내부 통합 문의함은 8번, 뒤의 확인 범위는 9번으로 순서화했다. 목록·필터·상세·담당자·상태·1회 전환·빠른 수기 접수·401/중복/권한 오류 대응과 별도 상단 탭·외부 connector 미연결 안내는 유지했다. SHA256 `15F3CC405FD45A5EFA306BBC5134F2589FCD71020287F22D186A72A0664328B0`; 문단 50·표 6·기존 이미지 1을 유지했다.
- Pandoc→Edge headless→PDF→6페이지 PNG 시각 QA에서 번호 결함을 발견·수정했고 전 페이지 가독성/잘림 확인 PASS(Word 원본 렌더가 아닌 대체 렌더)다. 실제 외부 카카오·당근·네이버 자동 connector는 구현·운영하지 않았다.
